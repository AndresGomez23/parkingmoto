...
public class ServicioCrearMotoTest {
    ...
    void deberiaLanzarUnaExepcionCuandoSeValideLaExistenciaDelUsuario() {
        ...
        ServicioCrearMoto servicioCrearMoto = new ServicioCrearMoto(repositorioUsuario);
        // act - assert
        BasePrueba.assertThrows(() -> servicioCrearMoto.ejecutar(usuario), ExcepcionDuplicidad.class,"El usuario ya existe en el sistema");
    }
    ...
    void deberiaCrearElUsuarioDeManeraCorrecta() {
        ...
        ServicioCrearMoto servicioCrearMoto = new ServicioCrearMoto(repositorioUsuario);
        // act
        Long idUsuario = servicioCrearMoto.ejecutar(usuario);
        //- assert
