...
import static com.ceiba.dominio.ValidadorArgumento.validarObligatorio;
    ...
    public class Carro {private static final String SE_DEBE_INGRESAR_LA_FECHA_CREACION = "Se debe ingresar la fecha de creación";
    ...
    private static final String SE_DEBE_INGRESAR_LA_PLACA = "Se debe ingresar el nombre de usuario";
    ...
    public Carro(String placa,String cilindraje, LocalDateTime fechaIngreso) {
        validarObligatorio(placa, SE_DEBE_INGRESAR_LA_PLACA);
        validarObligatorio(cilindraje, SE_DEBE_INGRESAR_EL_CILINDRAJE);
        validarLongitud(placa, LONGITUD_MINIMA_CLAVE, String.format(LA_PLACA_DEBE_TENER_UNA_LONGITUD_IGUAL_A,LONGITUD_MINIMA_CLAVE));
